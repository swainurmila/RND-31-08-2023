...
// Route::get('/phdstudent/asd/{id}', [PHDStudentController::class, 'asdf_demo']);


//Route::view('/', [HomeController::class, 'index'])->name('home_index');

Route::get('/', [HomeController::class, 'index'])->name('frontend');
//Route::get('/invoice', [HomeController::class, 'invoice'])->name('invoice');


Route::get('/bput-r&d-login', [LoginController::class, 'rndLogin'])->name('rndLogin');
...
// Route::get('refresh-captcha', [RegisterController::class, 'refreshCaptcha'])->name('reg.refreshCaptcha');
...
Route::group(['prefix' => 'admin', 'middleware' => 'role:admin'], function () {
    ...
    Route::get('/announcements/destroy/{id}', [AnnouncementController::class, 'destroy'])->name('announcements.destroy');
    ...
    Route::post('/departments/edit/{id}', [DepartmentController::class, 'update'])->name('departments.update');
    ...
    Route::get('/cosupervisor/applied-application', [AdminController::class, 'cosupervisor_appliedApplication'])->name('admin.cosup.applied-application');

    Route::get('/cosupervisor/preview-application/{id}', [AdminController::class, 'coSupPreviewApplication'])->name('admin.cosup.preview-application');
...
Route::group(['prefix' => 'phdstudent', 'middleware' => 'role:student'], function () {
    ...
    Route::get('/semister-registration-form/{sem}', [PHDStudentController::class, 'semisterRegistrationForm'])->name('semister-registration-form');
    ...
    Route::get('/student-semester-list/{id}', [PHDStudentController::class, 'semester_list'])->name('semester.list');
    Route::get('/student-semester-view/{id}', [PHDStudentController::class, 'semester_list_view'])->name('student.semester.view');
...
//change of nodal center
    ...
    Route::get('/co-supervisor-change-list', [PHDStudentController::class, 'changeOfCoSupervisorList'])->name('co-supervisor-change-list');
...
Route::group(['prefix' => 'control-cell', 'middleware' => 'role:control_cell', 'as' => 'control-cell.'], function () {
    ...
    Route::get('/verify-application/{id}', [ControlcellApplicationController::class, 'viewApplication'])->name('verify-application');
    Route::get('/supervisor/preview-application/{id}', [ControlcellApplicationController::class, 'SupPreviewApplication'])->name('sup.preview-applicatextention-to-work-apply
    ion');
