...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>SEMESTER REGISTRATION FORM FOR Ph.D. PROGRAMME </u></b></h4>
            <p>(For the Odd Even Semester, 20__________)</p>
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="enrollment_fee"><b>1. Name of Research Student : <span
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="registration_fee"><b>2. Name of the BPUT- NCR : <span
                                class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="semester_fee"><b>3. Name of the of the Department : <span
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>4. Enrollment No. & Date of Enrollment
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>5.Regd. No with date of Registration
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>6. Name of the Research Supervisor
                            : <span class="error">*</span></b><br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>8. Board Area of Research
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="borad_area" class="form-control" placeholder="">
                    </div>
                </div>
                <!--<div class="mb-2 row">
               ...
               <!-- <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/phd_semesterform" class="button">Submit</a>
                    </div>
                </div>
