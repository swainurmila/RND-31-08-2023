...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>APPLICATION FOR INCLUSION OF CO-SUPERVISOR </u></b></h4>
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>8. Name of the Research Supervisor
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
               ...
               <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>9. Name of the Proposed Co-Supervisor
               ...
               <!-- <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/inclusionform" class="button">Submit</a>
                    </div>
                </div>
