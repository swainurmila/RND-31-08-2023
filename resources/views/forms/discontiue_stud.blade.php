...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>APPLICATION FOR DISCONTINUATION AS Ph.D. STUDENT</u></b></h4>
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>4. Regd. No. & Date 
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>5. Branch / Specialization
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>7. Present Nodal Research Centre :
                     <span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="nodal_center" class="form-control" placeholder="">
                    </div>
                </div>
            <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>8. Details of research paper/s published :
                     
                        <span  class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="paper" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>9. Progress Done so far 
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="progress" class="form-control" placeholder="">
                    </div>
                </div>
                <!--<div class="mb-2 row">
               ...
               <!-- <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/discontiue_studform" class="button">Submit</a>
                    </div>
                </div>
