...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>THESIS SUBMISSION FORM</u></b></h4>
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="enrollment_fee"><b>1. Name of Candidate: : <span
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>7. Name of the Research
                        Supervisor
                         :
                     <span class="error">*</span></b></br></label>
                    <div class="col-md-8">
            ...
            <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>8. Name of issuing Bank  :
                     
                        <span  class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="bank" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>9. Demand Draft Number:
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="draft_no" class="form-control" placeholder="">
                    </div>
                </div>
                <!--<div class="mb-2 row">
               ...
               <!-- <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/thesis-submissionform" class="button">Submit</a>
                    </div>
                </div>
