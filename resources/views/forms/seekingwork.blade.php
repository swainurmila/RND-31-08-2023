    ...
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="registration_fee"><b>2.Name of the Faculty &  Branch / Specialisation : <span
                                class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>4. Enrollment No. & Date of
                            Enrollment
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>5. Regd. No. & Date of Regd 
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>7. Proposed title of the Ph.D TheSis
                            : <span class="error">*</span></b><br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>6. Caste Status: GEN/SC/ST
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/seekingworkform" class="button">Submit</a>
                    </div>
                </div>
