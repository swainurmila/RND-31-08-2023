    ...
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="reg_renewal_fee"><b>4.Enrollment No. & Date : <span
                                class="error">*</span></b><br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>5.Department /NCR to which
                        admitted
                        
                            : <span class="error">*</span></b><br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="dept" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="mb-2 row">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>7. Category (GEN /SC / ST) :
                     <span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>9. Faculty (Engg./Pharm. Etc.)
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>10. Discipline/ Specialization
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>11. Broad Area of Research
                        Proposed
                        
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="broad" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/dsc_researchform" class="button">Submit</a>
                    </div>
                </div>
