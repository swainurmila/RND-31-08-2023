...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>APPLICATION FOR COURSEWORK ALLOTMENT IN Ph.D PROGRAMME (FIRST DSC
                        MEETING) </u></b></h4>
            <p>(This form must be submitted within 15 days of Enrollment of a student joining the programme at
                BPUT-NCR)
            ...
            <form action="" class="form" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="registration_fee"><b>4. Name of Principal Supervisor :
                            <span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="registration_fee" name="name_principal" class="form-control"
                            placeholder="">
                    </div>
                </div>
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>5. Name of the Co-Supervisor
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>6. Branch / Specialisation
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>7. Enrollment No. & Date of
                            Enrollment
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>8. Proposed title of the Ph.D TheSis
                            : <span class="error">*</span></b><br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>9. Caste Status: GEN/SC/ST
                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>10. Category of studentship

                            :<span class="error">*</span></b></br></label>
                    <div class="col-md-8">
                        <input type="text" id="thesis_sub_fee" name="student" class="form-control" placeholder="">
                    </div>
                </div>
                <!-- <div class="mb-2 row">
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/allotmentform" class="button">Submit</a>
                    </div>
                </div>
