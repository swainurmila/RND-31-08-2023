...
<section class="sptb portal_background ">
    <div class="container form-border-container">
        <div class="phd-form-section-title form-section-title">
            ...
            <h4 style="text-align:center"><b><u>Application and recommendation of DSC for provisional registration to Ph.D degree</u></b></h4>
            ...
            <div class="mb-2 row">
               ...
               <div class="mb-2 row">
                ...
                <div class="mb-2 row">
                    <label class="col-md-4 col-form-label" for="thesis_sub_fee"><b>13.Earliest date of thesis Submission
                ...
                <div style="overflow:auto;">
                    <div style="float:right; margin-top: 5px;">
                        <a href="/provisional-form" class="button">Submit</a>
                    </div>
                </div>
