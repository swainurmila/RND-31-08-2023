            ...
            <div class="card">
                <div class="card-body">
                    <div class="section-title form-section-title mb-3">
                        <h3 class="text-center"><b>Recommendation of VC For Provisional Registration to Ph.D
                                Programme of BPUT</b>
                        </h3>
                    </div>
                    <div class="row">
                    ...
                    <form method="post" action="{{ route('vc.provisional-registration-submit', [$id]) }}"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            @if ($provisional->status == 10)
                                <div class="col-md-2">
                                    <span>Recommendation of VC:</span>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6">
                                    <textarea name="vc_remark" id="vc_remark" class="form-control" cols="30" rows="2"
                                        placeholder="{{ $provisional->vc_remark }}Enter Provisional registration remarks here..." required></textarea>
                                </div>
                            @else
                                <div class="mb-4 card">
                                    <div class="row">
