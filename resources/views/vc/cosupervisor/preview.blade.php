...
@section('sub-heading', 'Co-Supervisor')
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('vc.sup.vc.remark.submit',[$id]) }}" method="post" class="comm_frm prev_wrap">
                                        @csrf
                                        ...
                                        <div class="input_wrap preview_form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label">{{ $supervisors->name }}</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Faculty:</label>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label>Name of the Institution / Organisation with detailed
                                                        address:</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label
                                                        class="form-label">{{ $supervisors->institution_organisation }}</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Nature of Present Appointment as Teaacher/Scientist (Full time
                                                        Regular / Contractual / Part-time / Guest / Resource
                                                        Person):</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label
                                                        class="form-label">{{ $supervisors->present_appointment }}</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <label
                                                        class="form-label">{{ $supervisors->correspondence_address }}</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <label
                                                        class="form-label">{{ $supervisors->disciline_specialization }}</label>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($SupervisorQualification as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea class="form-control" readonly style="width:120px">{{ $value->control_cell_remarks }}</textarea>
                                                                    </td>
                                                                    <td>
                                                                        <select name="sup_quali_status[]"
                                                                    ...
                                                                    <td>
                                                                        <textarea name="sup_quali_remarks[]" class="form-control" style="width:120px">{{ $value->vc_remarks }}</textarea>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                        ...
                                        <div class="input_wrap preview_form">
                                          ...
                                          <td>
                                            <textarea name="sup_emp_remarks[]" class="form-control"  style="width:120px;">{{ $value->vc_remarks }}</textarea >
                                          </td>
...
<tr>
                                ...
                                <td><a href="javascript:void(0)"
                                  ...
                                  <td>
                                    <textarea name="sup_pub_remarks[]" class="form-control"   style="width:120px" >{{ $value->vc_remarks }}</textarea >
                                  </td>
                            </tr>
@endforeach
...
<tr>
                                ...
                                <td>
                                  ...
                                  <td>
                                    <textarea readonly  class="form-control" style="width:120px">{{ $value->control_cell_remarks }}</textarea >
                                  </td>
                                   <td>
                                  ...
                                  <td>
                                    <textarea name="sup_jour_remarks[]"  class="form-control" style="width:120px">{{ $value->vc_remarks }}</textarea >
                                  </td>
                            </tr>
@endforeach
...
<tr>
                                ...
                                <td>{{ $value->university_name }}</td>
                                  ...
                                  <td>
                                    <textarea name="sup_det_remarks[]" class="form-control" style="width:120px" >{{ $value->vc_remarks }}</textarea >
                                  </td>
                            </tr>
@endforeach
            ...
            <div class="input_wrap preview_form">   
                ...
                {{-- <div class="col-md-4">
                    Remark:
                    <textarea name="sup_certi_remarks" class="form-control" readonly >
                        {{ $supervisors->control_cell_remarks }}
                                            </textarea>
                </div>                 --}}
            </div>                           
                <div class="row">
                    <div class="form-group">
                        <label style="width: 100%;font-weight: 700; margin-bottom: 10px;"> Controll Cell Remarks:</label>
                        <textarea class="rema form-control" style="width: 80%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; border: none; margin-bottom: 20px;" name="super_remark"  readonly>{{ $supervisors->control_cell_remarks }}</textarea>
                                                </div>
                                                {{-- <div class="form-group">
                        <label style="width: 100%;font-weight: 700; margin-bottom: 10px;">Registrar Remarks:</label>
                        <textarea class="rema form-control" style="width: 80%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; border: none; margin-bottom: 20px;" name="chair_remark" readonly>{{ $supervisors->registrar_remarks}}</textarea>
                    </div> --}}
                                                {{-- <div class="form-group">
                                                    <label style="width: 100%;font-weight: 700; margin-bottom: 10px;">VC
                                                        Remarks:</label>
                                                    <textarea class="rema form-control"
                                                        ...
                                                        name="vc_remark">{{ $supervisors->vc_remarks }}</textarea>
                                                </div> --}}
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        Status:
                                                        <select name="sup_certi_status" class="form-control" required>
                                                            ...
                                                            <option value="Approved"
                                                                {{ $supervisors->control_cell_status == 'Approved' ? 'selected' : '' }}>
                                                                Approved</option>
                                                            <option value="Reject"
                                                                {{ $supervisors->control_cell_status == 'Reject' ? 'selected' : '' }}>
                                                                Reject</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        Remark:
                                                        <textarea name="vc_remark" class="form-control" required>{{ $supervisors->control_cell_remarks }}
                                                    </textarea>
                                                    </div>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="defaultUnchecked" checked required>
                                                    <label class="custom-control-label" for="defaultUnchecked">I agree and
                                                        review the declaration / terms&amp;conditions</label>
                                                </div>
                                            </div>
                                            <div class="border border-primary mt-2 mb-2"></div>
                                            @if ($supervisors->application_status == 2)
                                                <div class="row">

                                                    <div class="cust-print mt-4 text-center">
