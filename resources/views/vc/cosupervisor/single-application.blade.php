                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('vc.cosup.vc.remark.store',[$id]) }}" method="post" class="comm_frm prev_wrap">
                                        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="rema form-control" style="width: 80%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; border: none; margin-bottom: 20px;" name="chair_remark" readonly>{{ $supervisors->registrar_remarks}}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        Remark:
                                                        <textarea name="vc_remark" class="form-control" required>{{ $supervisors->vc_remarks }}
                                                    </textarea>
                                                    </div>
                                                </div>
