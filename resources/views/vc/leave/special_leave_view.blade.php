                    ...
                    <div class="card-body">
                                ...
                                <div class="section-title form-section-title mb-3">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{$student->nodal_status == 1 ? 'Recommended' : 'Not Recommended'}}" readonly >
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    @if($student->vc_status == 0)
                                    <form method="post" action="{{ route('vc.leave.status',[$student->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="app_div">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label>Status</label>
                                <input class="form-control" type="text" value="{{ $student->vc_status == 1 ? 'Approved' : 'Not Approved' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label>Remarks</label>
