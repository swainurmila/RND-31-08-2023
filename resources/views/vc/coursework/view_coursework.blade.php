                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-accordion">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form action="{{ route('vc.view-coursework-update') }}" method="post"
                                        ...
                                        <table class="table table-bordered coursework-form-display-table">
                                            ...
                                            <tr>
                                                ...
                                                @endif
                                                @if ($details->vc_comment != '')
                                                    <td>{!! Str::length($details->vc_comment) > 35
                                                        ? Str::limit($details->vc_comment, 35)
                                                        : $details->vc_comment !!}
                                                        @if (Str::length($details->vc_comment) > 35)
                                                            <a href="javascript:void(0);"
                                                                onclick="view_remark('{{ $details->vc_comment }}');">view</a>
                                                        @endif
                                                    </td>
                                                @endif 
                                            </tr>
                                        ...
                                        <div class="row">
                                            @if($details->status == 8)
                                                <div class="col-md-2">
                                                    <span>Approval of Vice Chancellor</span>
                                                </div>
                                                <div class="col-md-3">
