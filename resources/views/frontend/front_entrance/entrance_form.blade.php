...
@section('content')
                    ...
                    <section class="fee_structure clearfix" style="margin-top: 80px; padding: 50px 40px;">
                        <div class="section-title form-section-title dsc-form">
                            ...
                            <center>
                                ...
                                <div class="dd_f1">
                                    <div class="dd_details">(DD No. <input type="text" class="form-control"
                                            name="dd_no" style="width: 200px"></div>
                                    ...
                                    <div class="dd_details"> Bank Name:<input type="text" class="form-control"
                                            name="dd_bank"style="width: 200px"> </div>
                                            ...
                                            <div class="comm_div d-flex">
                                                ...
                                                <div class="div_R">
                                                    <input type="text" name="mobile" class="form-control"
                                                        style="width: 250px;" pattern="[0-9]+" maxlength="10">
                                                </div>
                                ...
                                <option value="canadian">Canadian</option>      
                                    ...
                                    <div class="comm_div d-flex">
                                        ...
                                        <div class="div_R">
                                            <input type="text" name="mother_tounge" class="form-control"
                                                style="width: 250px;">
                                        </div>
                                    </div>
                                        ...
                                        <div class="info-data info-desk" style="margin-top: 40px;">
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>1</th>
                                                        <td><input type="text" name="selection_ncr2[]"
                                    ...
                                    <div class="form-row clearfix" id="add_phdstudent_qualfication">
                                        ...
                                        <div class="col-md-4 cust-txt-input">
                                            ...
                                            <input type="text" id="phdstudent_board_university" value=""
                                                class="form-control" placeholder="Enter the Board/University Name "
                                                name="phdstudent_board_university">
                                        ...
                                        <div class="col-md-4 cust-txt-input">
                                            <label class=" col-form-label" for="phdstudent_passing_year"><b>Year of
                                                    Passing</b></label>
                                            <select class="form-select form-control" id="phdstudent_passing_year"
                                        ...
                                        <div class="col-md-2 cust-txt-input">
                                            ...
                                            <input type="text" id="phdstudent_percentage_cgpa" value=""
                                                class="form-control" placeholder="Enter marks/CGPA"
                                                name="phdstudent_percentage_cgpa">
                                        ...
                                        <div class="col-md-4 cust-txt-input">
                                            ...
                                            <input type="text" id="phdstudent_major_sub" value=""
                                                class="form-control" placeholder="Enter Subject/ Specialization"
                                                name="phdstudent_major_sub">
    ...
    <div style="text-align: center"></div>
        <h4 style="text-align: center;min-height:500px;margin-top:40px;color:red"> BPUT Ph.D Entrance Registration has been Closed!</span></h4>
    @endif
                    ...
                    success: function(data) {
                        ...
                        if (data.data == 1) {
                            Swal.fire({
                                ...
                                '<a href="http://115.243.153.202:8060/phd-entrance-test-draft/' + data.id + '">Click here</a> to proceed further.</span>',
                                position: 'center',
                                width: '400px', 
