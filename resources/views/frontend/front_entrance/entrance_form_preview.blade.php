...
@section('content')
                    ...
                    <tr>
                        <td style="border: none!important; padding: 0 !important;">
                            ...
                            <table class="per_det non_border_tab">
                                ...
                                <tr>
                                    ...
                                    <td class="text-uppercase">{{ $prog->program }} </td>
                                    <th>Branch/Specialiazation: </th>
                                    <td class="text-uppercase">{{ $prog->departments_title }} </td>
                                </tr>
                                <tr>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <p>In case of selection, Choice of BPUT-Nodal Center of Research (NCR) <br>(in
                                            order of
                            ...
                            <table style="margin-top: 10px;">
                                <tr>
                                    <td>
                                        <h5>Educational Qualification (HSC onwards) [Enclose self attested copy of
                                            documents]
                                        </h5>
                                    </td>
                                </tr>
                        ...
                        <tr>
                            ...
                            <table style="margin-top: 100px;">
                                ...
                                <tr>
                                    <th>1</th>
                                    <th class="text-left">High School Pass Certificate Examination or Other equivalent
                                        Examination Pass Certificate</th>
                                    <th><input type="checkbox" value="high_school_pass"
                                            {{ in_array('high_school_pass', $enclosures) ? 'checked' : '' }}
                                            name="check_info[]" id=""></th>
                                </tr>
                                <tr>
                                    <th>2</th>
                                    <th class="text-left">Memorandum of Marks of high School Certificate Examination or
                                        equivalent
                                        Examinations</th>
                                    <th><input type="checkbox" value="memorandum_high_school"
                                            {{ in_array('memorandum_high_school', $enclosures) ? 'checked' : '' }}
                                            name="check_info[]" id=""></th>
                                </tr>
                                <tr>
                                    <th>3</th>
                                    <th class="text-left">Pass certificates of intermediate/Diploma(Engg.etc.)Examinations
                                    </th>
                                    <th><input type="checkbox" value="memorandum_high_school"
                                            {{ in_array('memorandum_high_school', $enclosures) ? 'checked' : '' }}
                                            name="check_info[]" id=""></th>
                                ...
                                <tr>
                                    <th>4</th>
                                    <th class="text-left">Memorandum of Marks of intermediate/Diploma(Engg.etc.)Examinations
                                    </th>
                                    <th><input type="checkbox" value="memorandum_marks_intermediate"
                                ...
                                <tr>
                                    ...
                                    <th><input type="checkbox" value="certificate_of_ug"
                                ...
                                <tr>
                                    ...
                                    <th><input type="checkbox" value="memorandum_marks_ug"
                                ...
                                <tr>
                                    ...
                                    <th><input type="checkbox" value="certificate_of_pg_mphill"
                                ...
                                <tr>
                                    <th>9</th>
                                    <th class="text-left">Certificate in support of SC/ST/Differently abled Catagory as the
                                        case may be (Mention Clearly)</th>
                                    <th><input type="checkbox" value="certificate_of_sc_st"
                                            {{ in_array('certificate_of_sc_st', $enclosures) ? 'checked' : '' }}
                                            name="check_info[]" id=""></th>
                                </tr>
                                <tr>
                                    <th>10</th>
                                    <th class="text-left">Proof of National Eligibility Test qualified if any(GATE/NET
                                        etc.)</th>
                                    <th><input type="checkbox" value="national_eligibility"
                                            {{ in_array('national_eligibility', $enclosures) ? 'checked' : '' }}
                                            name="check_info[]" id=""></th>
                                </tr>
                                <tr>
                                    <th>11</th>
                                    <th class="text-left">Passport size photograph</th>
                                    <th><input type="checkbox"
                                            {{ in_array('passport_photo', $enclosures) ? 'checked' : '' }}
                                            value="passport_photo" name="check_info[]" id=""></th>
                                </tr>
                                <tr>
                                    <th>12</th>
                                    ...
                                    <th><input type="checkbox"
                                            ...
                                            value="aadhaar_card" name="check_info[]" id=""></th>
                                </tr>
                    ...
                    <div class="section-title form-section-title dsc-form">
                        ...
                        500kb)</i></small> --}}
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="file_up">
                                                ...
                                                <div class="view_file text-left" style="margin-top: 10px;">
                                                    <a href="javascript:void(0)"
                                                        onclick="show_certi('{{ $phdCerti->memo_ug }}')">View File</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 text-center">
                                    ...
                                    <input type="hidden" value="{{ $phd_data->registration_no }}" name="ref_id">
    ...
    <h4 style="text-align: center;min-height:500px;margin-top:40px;">Your form has been submitted successfully and your reference id is -&nbsp;&nbsp;&nbsp;<span style="color: red">{{ $phd_data->registration_no }}</span></h4>
	@endif
...
@section('jss')
    ...
    {{-- <script>
        document.querySelector('form').addEventListener('submit', function(event) {
            ...
            // Show the pop-up window with the message after the form is submitted
