...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="sptb">
            ...
            <div class="container">
                <div class="card"
                    style="background:  position: relative; box-shadow:rgb(0 0 0 / 35%) 0px 5px 15px;margin-top:50px;margin-bottom:150px;margin-left: 90px;height:200px">
                    <div class="card-content" style="text-align: center;padding-top: 25px;">
                        ...
                        <p>Click on the Link to Download your Admit Card -<a href="#"><b> Download <i
