                                ...
                                <div class="present" style="padding-top:30px;  "><u>Present Address</u>
                                     ...
                                     <p class="text-left" style="padding-top:10px;">
                                        ...
                                        <div class="comm_div d-flex">
                                            ...
                                            <div class="div_R">
                                                <input type="text" name="mobile" value="{{$phd_data->mobile}}" class="form-control" style="width: 250px;">
                                            </div>
                                        ...
                                        <div class="comm_div d-flex">
                                            ...
                                            <div class="div_R">
                                                <input type="text" name="email" value="{{$phd_data->email}}" class="form-control" style="width: 250px;">
                                            </div>
                    ...
                    <div class="comm_div d-flex">
                        ...
                        <div class="div_R">
                            <div id="datepicker" class="input-group date">
                                <input class="form-control" type="text" name="dob" value="{{$phd_data->dob }}"   />
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                        </div>
