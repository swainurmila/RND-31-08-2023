                ...
                <td style="border: none!important; padding: 0 !important;">
                    ...
                    <table class="per_det non_border_tab">
                        ...
                        <tr>
                            ...
                            <td>{{$phd_data->gender}}</td>
                        </tr>
                        <tr>
                            <th>Marital status (Married / Single) :</th>
                            <td>{{$phd_data->marital_status}}</td>
                        </tr>
                        <tr>
                            <th>Date of Birth :</th>
                            <td>{{$phd_data->dob}} </td>
                        ...
                        <tr>
                            ...
                            <td>{{$phd_data->category}}</td>
                        </tr>
                        <tr>
                            <th>Nationality :</th>
                            <td> {{$phd_data->nationality}} </td>
                        </tr>
                        <tr>
                            <th> Mother Tongue : </th>
                            <td>{{$phd_data->mother_tounge}} </td>
                        </tr>
                        <tr>
                    ...
                    <table>
                        <tr>
                            <td><h4>In case of selection, Choice of BPUT-NCR (in order of preference)</h4></td>
                        </tr>
                    </table>
                    ...
                    <table style="margin-top: 10px;">
                        <tr>
                            <td><h4>Educational Qualification (HSC onwards) [Enclose self attested copy of documents]</h4></td>
                        </tr>
                    </table>
                    ...
                    <table class="non_border_tab" style="margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><img src="/upload/phd_entrance/{{$phd_data->signature}}" alt="" style="max-width: 100px; border:2px solid; margin-bottom:10px;"><p> <b>Signature Of the candidate :</b><p>  </td>
                        </tr>
                        <tr>
