                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <table class="table ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{$student->supervisor_status == 2 ? 'Recommended' : 'Not Recommended'}}" readonly >
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <form method="post" action="{{ route('nodalcentre.extention.work.status',[$student->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="app_div">
                                            <div class="row">
                                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>Status</label>
                                <input class="form-control" type="text" value="{{ $student->application_status == 4 ? 'Recommended' : 'Not Recommended' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label>Remarks</label>
