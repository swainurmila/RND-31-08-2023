                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="section-title form-section-title mb-3">
                                    ...
                                    <form method="post" action="{{ route('nodalcentre.semester-register-store', [$id]) }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @if ($payemt_status->status == 2)
                                            <div class="row mb-4">
                                                <label>
                                                    <input type="checkbox" name="ncr_cert" value="1" required>
                                                ...
                                                @if ($payemt_status->status == 2)
                                                    ...
                                                    <div class="col-md-5">
                                                        <textarea name="ncr_remark" id="ncr_remark" class="form-control" cols="30" rows="2"
                                                            placeholder="{{ $payemt_status->ncr_remark }}Enter Semester remarks here..." required></textarea>
                                                    </div>
                                                @else
                                                    <table class="table table-bordered coursework-form-display-table">
                                                        <tr class="trbg">
                                                            <th>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <h5>NCR Remark on Semester Registration:</h5>
                                                                    </div>
                                                                    <div class="col-md-9">
                                                                        <h5> {{ $payemt_status->ncr_remark }}</h5>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        </tr>
