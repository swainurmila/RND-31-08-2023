                                    ...
                                    <table id="datatable-buttons" class="table w-100 nowrap dataTable no-footer">
                                        ...
                                        <tbody>
                                            <?php $i = 1;foreach($value as $key=>$val){ ?>
                                                @if($val->name_of_ncr == Auth::guard('nodalcentre')->user()->id)
                                            <tr>
                                                <td>{{ $i }}</td>
                                                ...
                                                <td>@if($val->status == '1')
                                                    ...
                                                    @else
                                                    @endif</td>
                                                <td><a href="{{url('nodalcentre/view_change_supervisor/'.$val->res_ch_id )}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                            </tr>
                                            @endif
                                            <?php $i++;} ?>
                                        </tbody>
