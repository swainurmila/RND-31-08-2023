            ...
            <div class="card-body">
                <div class="panel-container show" role="content">
                    <div class="panel-content">
                                ...
                                <div class="panel-container show" role="content">
                                    <div class="panel-content">
                                        <table class="">
                                            <tr class="trbg">
                                                <th colspan="6">
                                                    <h5>Domain Expert from inside Odisha (Atleast one expert external to that BPUT-NCR)
                                                    </h5>
                                                </th>
                                            </tr>
                                            <tr>
                        ...
                        <form action="{{ route('nodalcentre.approve-application', ['id' => $student->id]) }}"
                            method="post">
                            @csrf
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select name="status" id="" class="form-control" required>
                                        ...
                                        <option value="2" {{ $student->application_status == 2 ? 'selected' : '' }}>
                                            Approve</option>
                                        <option value="3" {{ $student->application_status == 3 ? 'selected' : '' }}>
                                            Reject</option>
                                    </select>
                                </div>
                                <div class="col-4">
                                    <label for="">Remarks</label>
                                    <textarea name="application_remark" class="form-control" required>{{ $student->nodal_remarks != '' ? $student->nodal_remarks : '' }}</textarea>
                                </div>
                            </div>
