            ...
            <div class="card">
                <div class="card-body">
                    <div class="section-title form-section-title mb-3">
                        <h3 class="text-center"><b>Recommendation of NCR For Provisional Registration to Ph.D
                                Programme of BPUT</b>
                        </h3>
                    </div>
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-2">
                                    <h5>Co-Supervisor Remark:</h5>
                                </div>
                                <div class="col-md-10">
                                    <h5> {{ $provisional->cosup_remark }}</h5>
                                </div>
                            </div>
                        </div>
                        <form method="post" action="{{ route('nodalcentre.provisional-registration-submit', [$id]) }}"
                            enctype="multipart/form-data">
                            @csrf
                            <h5>DSC SIGNED LETTER</h5>
                            @if ($provisional->status == 4)
                            <div class="col-md-12 mb-4">
                                <span><b>PROVISION REGISTRATION BY THE DSC AT THE NCR LETTER:
                                    </b></span><span><a
                                        href="{{ route('nodalcentre.provisional-dsc-letter', $provisional->id) }}"
                                        class="badge bg-success text-uppercase">DOWNLOAD</a>
                                </span>
                            </div>
                            <div class="col-md-4 mb-4">
                                <span>Upload Letter:</span><span><input type="file" class="form-control"
                                        value="" name="dsc_signed_cert" id="dsc_signed_cert" required></span>
                            </div>
                            @else
                            ...
                            <div class="row">
                                @if ($provisional->status == 4)
                                    <div class="col-md-2">
                                        <span>Recommendation of Nodal Center:</span>
                                    </div>
                                    <div class="col-md-3">
                                        <select name="status" class="form-control" required>
                                            <option value="">--------select--------</option>
                                            <option value="6">Recommend</option>
                                            <option value="7">Not Recommend</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1">
                                        <span>Comment:</span>
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="ncr_remark" id="ncr_remark" class="form-control" cols="30" rows="2"
                                            placeholder="{{ $provisional->ncr_remark }}Enter Provisional registration remarks here..." required></textarea>
                                    </div>
                                @else
                                    <div class="mb-4 card">
                                        <div class="row">
