                        ...
                        @foreach ($applications as $key => $value)
                            <tr>
                                ...
                                <td class="table-action col-action">
                                    @if (($value->notification_no !== null || $value->notification_date !== null) && $value->notified == 0)
                                        <a href="{{ route('je.notify.view', [$value->id]) }}" class="btn-sm btn-primary">
                                            View Details</a>
                                    @else
                                        <a href="{{ route('je.verify-application', ['id' => $value->id]) }}"
                                    ...
                                    @endif
                                    @if (
                                        $value->get_coursework_details &&
                                            in_array($value->get_coursework_details->status, [4, 6, 7, 8, 9, 10, 11, 12, 14, 15]))
                                        <a href="{{ route('je.view-coursework', ['id' => $value->get_coursework_details->id]) }}"
