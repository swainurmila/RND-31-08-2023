                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="section-title form-section-title mb-3">
                                    ...
                                    <div class="col-md-12">
                                        @if ($payemt_status->status == 8)
                                            <span><b>Notification for Approval of PHD Semester Registration:</b></span>&nbsp;&nbsp;&nbsp;<span><a href="{{route('je.notify-semester-register', $id)}}" class="btn btn-success notify_student">Notify student</a></span>
                                        @elseif($payemt_status->status == 10)
                                        <div class="row">
                                            <div class="col-md-5">
                                    ...
                                    <form method="post" action="{{ route('je.semester-register-store', [$id]) }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                            <div class="row">
                                                @if ($payemt_status->status == 4)
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select name="status" class="form-control" required>
                                                            ...
                                                            <option value="7">Not Verified</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <span>Comment:</span>
                                                    ...
                                                    <div class="col-md-5">
                                                        <textarea name="je_remark" id="je_remark" class="form-control" cols="30" rows="2"
                                                            placeholder="{{ $payemt_status->je_remark }}Enter Semester remarks here..." required></textarea>
                                                    </div>
                                                @else
                                                    <table class="table table-bordered coursework-form-display-table">
                                                        <tr class="trbg">
                                                            <th>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <h5>JE Remark on Semester Registration:</h5>
                                                                    </div>
                                                                    <div class="col-md-9">
                                                                        <h5> {{ $payemt_status->je_remark }}</h5>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        </tr>
