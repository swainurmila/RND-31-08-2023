                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3" dir="ltr">
                                <div id="campaigns-chart2" class="apex-charts"
                                    data-colors="#27d4e3,#d9d615,#f56d15,#de417f,#2c77a2,#b874bf,#fd5e8f,#25097a,#4d0662,#1d6266,#000,#ffffff">
                                </div>
                            </div>
                            <div class="graph_wrap text-center mt-2">
                                @php
                                    $color = ['#27d4e3','#d9d615','#f56d15','#de417f','#2c77a2','#b874bf','#fd5e8f','#25097a','#4d0662','#1d6266','#000','#ffffff'];
                                   // dd($color);
                                  
                                   $numbers = [44, 55, 41, 26, 63, 14, 23, 44, 36, 12, 24,32];
                                   //dd($numbers);
                                   $i = 0;
                                @endphp
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="row">
                                <div class="col-auto d-grid mt-2">
                                    <a class="btn btn-primary cust_btn" href="{{ route('nodal.list') }}">View all</a>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto d-grid mt-4">
                                            <a class="btn btn-primary cust_btn" href="{{ route('supervisor-application') }}">View
                                                all</a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto d-grid mt-2 text-center">
                                            <a class="btn btn-primary cust_btn" href="{{ route('departments') }}">View all</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-body -->
...
@if (session('userdata')['role_id'] == '1')
    @section('js')
        <script>
            ...
            var colors = ["#ea54ce", "#8ea310", "#986281", "#e1566c", "#daf0b5", "#291b2e", "#a0c8a6", "#b40e11", "#173f8d",
                "#eab3c3"
            ];
