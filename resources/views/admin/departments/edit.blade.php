            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form action="{{ route('departments.update', $departments->id) }}" class="form"
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="title"
                                                value="{{ $departments->departments_title }}" name="title"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-md-1 color">
                                            <input type="color" id="colorpicker"
                                                ...
                                                value="{{ $departments->color }}">
                                        </div>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="color"
                                                pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$"
                                                value="{{ $departments->color }}" id="hexcolor">
                                            @if ($errors->has('color'))
