                    ...
                    <div class="card-body">
                        <div class="panel-container show" role="content">
                            <div class="panel-content" style="padding: 20px 30px; ">
                                ...
                                <form method="POST" action="{{ route('semester-registration-form-submit') }}"
                                    ...
                                    <div class="row semester">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="month_elapsed"
                                                    value="" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="reg_status">Registration Status Upto Date</label>
