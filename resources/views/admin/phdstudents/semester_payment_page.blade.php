                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="elapsed_month">Name of the Student: </label>
                                                            </div>
                                                            <div class="col-md-6">
                                                                {{ $sem_payment->name }}
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <label for="elapsed_month">Enrollment No.: </label>
                                                            </div>
                                                            <div class="col-md-6">
                                                                {{ $sem_payment->enrollment_no }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label for="elapsed_month">Semester: </label>
                                                            </div>
                                                            <div class="col-md-6">
                                                                {{ $sem_payment->semester }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row mt-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="date" class="form-control" id="ncr_pdate"
                                                                    name="ncr_pdate" value="{{ date('Y-m-d') }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-1">
                                                            <div class="col-md-6">
                                                    ...
                                                    @else
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6"><span><b>
                                                                            @if ($sem_payment->ncr_pmode == 'draft')
                                                                                DRAFT
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <span><b>{{ $sem_payment->ncr_pbank ? $sem_payment->ncr_pbank : '-' }}</b></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <span><b>{{ $sem_payment->ncr_pdate }}</b></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <span><b>{{ $sem_payment->ncr_pamount }}</b></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <a href="javascript:void(0);"
                                                                        onclick="upload_image_view('{{ $sem_payment->ncr_preceipt }}')"
                                ...
                                <form id="bputpaymentForm" method="POST"
                                    ...
                                    @csrf
                                    <br>
                                    <div class="{{ $sem_payment->ncr_preceipt != null ? 'd-block' : 'd-none' }}">
                                        <div class="border border-primary mb-4 card">
                                            <div class="card-header">
                                                    ...
                                                    <div class="row mt-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" id="bput_pdate"
                                                                name="bput_pdate" value="{{ date('Y-m-d') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
