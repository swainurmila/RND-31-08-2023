                        ...
                        <table>
                            <tr>
                                ...
                                <th style="text-align: right;">
                                    <div class="enroll_no">
                                        <h5>Enrollment No:</h5>
                                        <h5 style="color: red;">{{ $student->enrollment_no }}</h5>
                                    </div>
                                </th>
                                <th colspan="2" style="text-align: right;">
                                    <div class="text-center">
                                        <a class="btn btn-primary cust_btn"
                                            href="{{ route('invoice', [$student->id]) }}">View Invoice
                                        </a>

                                        @if (in_array($student->application_status, [10, 11, 12]))
                                            {{-- <a class="btn btn-primary cust_btn" target="_blank"
                                                href="{{ route('show.students.dsc', [$student->id]) }}">View Domain Experts
                                            </a> --}}
                                            
                                            @if ($student->notified)
                                            <a class="btn btn-primary cust_btn" target="_blank"
                                                href="{{ route('je.notify.view', [$student->id]) }}">View Domain Experts Approved form
                                            </a>
                                            @endif
                                        @endif
                                    </div>
