                                    ...
                                    <table style="border: none">
                                        <tbody style="border: none">
                                            <tr style="border: none">
                                                <td style="border: none"><input type="checkbox" name="" id="" required> &nbsp;</td>
                                                <td style="border: none">I understand that this leave does not entitle me to extra classes, alternative examination or credit for class tests/home assignments. </td>
                                            </tr>
                                        </tbody>
