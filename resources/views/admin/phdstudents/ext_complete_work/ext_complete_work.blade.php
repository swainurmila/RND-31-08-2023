                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input class="form-control" type="hidden" name="nodal_center"
                                                    value="{{ $student->nodal_id }}" readonly>
                                            </td>
                                            <td>
                                                <label class="form-label">Date of commencement of course work:</label>
                                                <br>
                                                <input class="form-control" type="date" name="date_of_commencement"
                                                    value="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <input class="form-control" type="text" name="enrollment_no"
                                                    value="{{ $student->enrollment_no }}" readonly>
                                            </td>
                                            <td><label class="form-label">Enrollment.Date:</label>
                                                <br>
                                                <input class="form-control" type="text" name="enrollment_date"
                                        ...
                                        <tr>
                                            <td><label class="form-label"><label class="form-label">Not Registered for the
                                                        course work:</label><br>

                                            </td>
                                            <td>
                                                <input class="form-check-input" type="checkbox"
                                                    name="component_not_completed[]"
                                                    value="Not Registered for the course work" id="flexCheckDefault">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-check-input" type="checkbox"
                                                    name="component_not_completed[]"
                                                    value="Less than 75% Attendance in course Work" id="flexCheckDefault">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label class="form-label">Failed in one or more written
                                                    course/courses:</label><br>
                                            </td>
                                            <td>
                                                <input class="form-check-input" type="checkbox"
                                                    name="component_not_completed[]"
                                                    value="Failed in one or more written course/courses"
                                                    id="flexCheckDefault">
                                            </td>
                                        </tr>

                                        <tr>
                                            <td><label class="form-label">Did not do the assigned work of other
                                                    components:</label><br>
                                            </td>
                                            <td>
                                                <input class="form-check-input" type="checkbox"
                                                    name="component_not_completed[]"
                                                    value="Did not do the assigned work of other components"
                                                    id="flexCheckDefault">
                                            </td>
                                        </tr>
                                    </table>
