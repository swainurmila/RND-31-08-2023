                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <span class="badge {{ $value->control_status == 1 ? 'bg-success' : 'bg-warning' }} ">
                                        ...
                                        @if($value->supervisor_status == 2 && $value->nodal_status == 0)
                                        Pending To NCR
                                        @elseif($value->nodal_status == 1 && $value->control_status == 0) 
                                        Pending To ControlCell
                                        @elseif($value->control_status == 1 && $value->nodal_status == 1 && $value->supervisor_status == 2 )
                                        Approved   
                                        @else
                                        Pending To Supervisor
                                        @endif 
                                    </span> --}}
                                    <span
                                ...
                                <td class="table-action">
                                    <a href="{{route('extention.to.work.view',[$value->id])}}"
