...
@section('heading', 'CHANGE OF NODAL CENTRE')
                        ...
                        <div class="card-body">
                            <div class="border border-purple mb-4 card">
                                <div class="card-header mb-2">
                                    <div class="row">
                                        <div class="col-md-8 text-right">
                                            <h4 class="text-purple text-uppercase">Change of Nodal Research Supervisor
                                                {{-- and Co-supervisor</h4>
                                            @php
                                               
                                                $phdStatus = Helper::changeResearchSupStatus($details->app_id)['status'];
                                                $badgeColor = Helper::changeResearchSupStatus($details->app_id)['badge_color'];
                                               
                                            @endphp

                                            <span class="badge bg-{{ $badgeColor }} text-uppercase p-1">
                                                {{ $phdStatus }}
                                            </span> --}}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <b> Name of the Present Nodal Research Supervisor :</b>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <b>Name of the Proposed nodal Research Supervisor :</b>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <b> Name of the Present Nodal Research Co-Supervisor :</b>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <b>Name of the Proposed Nodal Research Co-Supervisor :</b>
                                            </div>
                                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <b>Present Status of the research work:</b>
                                            </div>
                                            <div class="col-md-8">
                                            ...
                                            <div class="col-md-8">
                                                <div class="col-md-4 mb-3">
                                                    <span><a href="javascript:void(0);"
                                                            onclick="upload_image_view('{{ $details->change_document }}')"
                            ...
                            <div class="text-center">
                                <a href="{{ url('/phdstudent/dashboard') }}"
                                    class="btn btn-purple waves-effect waves-light me-1">
                                    BACK</a>
                            </div>
