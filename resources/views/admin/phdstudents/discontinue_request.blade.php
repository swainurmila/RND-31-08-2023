            ...
            <div class="card-body">
                <table class="table table-hover m-0 table-centered  nowrap w-100" cellspacing="0" id="dataTable">
                    ...
                    <tbody class="font-14">
                        ...
                        @if($value->stud_id == Auth::guard('student')->user()->id)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td>{{ $value->name }}</td>
                            ...
                            <td>
                                ...
                                <span class="badge bg-success">Recommended by Supervisor</span>
                                ...
                                @else
                                <span class="badge bg-warning">pending at Supervisor</span>
                                @endif
                            </td>
                            <td><a href="{{url('phdstudent/discontinue-registration',$value->id)}}" class="action-icon"> <i class="mdi mdi-eye"></i></a></td>
                        </tr>
                        @endif
                        @endforeach 
                    </tbody>
