         ...
         @include('admin.partials.breadcrumb')
            <div class="row">
                ...
                <div class="panel-content">
                    ...
                    <form action="{{route('stu.preview.submit')}}" method="post" class="comm_frm prev_wrap">
                        @csrf
                        ...
                        <h3><b>Preview Claim Information</b> </h3>
                                                  ...
                                                  <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label class="form-label">{{$student->academic_programme}}</label>
                                                        </div>
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label class="form-label">{{$student->ncr_department}}</label>
                                                        </div>
                                                        <div class="col-md-3">
                                                             <label>Father's / Husband's Name:</label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label class="form-label">{{$student->father_husband}}</label>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label class="form-label">{{$student->registration_no}}</label>
                                                        </div>
...
<hr>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <label class="form-label">{{$student->permannt_address}}</label>
                                                        </div>
                                            </div>
                                            <div class="row">
                                                 <div class="col-md-3">
                                                ...
                                                <div class="col-md-7">
                                                   <label class="form-label">{{$student->present_address}}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label">{{$student->nationality}}</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label">{{$student->student_category}}</label>
                                                </div>
                                                <div class="col-md-3">
                        ...
                        <div class="input_wrap preview_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->supervisor_name}}</label>
                                </div>
                                <div class="col-md-3">
                                     <label>Supervisor Address:</label>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->supervisor_address}}</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->supervisor_email}}</label>
                                </div>
                                <div class="col-md-3">
                                     <label>Supervisor Phone:</label>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->supervisor_phone}}</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->co_supervisor_name}}</label>
                                </div>
                                <div class="col-md-3">
                                     <label>Co-Supervisor E-Mail:</label>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->co_supervisor_email}}</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->co_supervisor_address}}</label>
                                </div>
                                <div class="col-md-3">
                                     <label>Co-Supervisor Phone :</label>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">{{$supervisor->co_supervisor_phone}}</label>
                                </div>
                            </div>
                        ...
                        <div class="input_wrap preview_form">
                            ...
                            {{-- <div class="row">
                                <div class="form-group">
                                    <input type="radio" name="recommended" value="1" {{$supervisor->sup_status == '1' ? 'checked': 'required'}} > Recommended <input type="radio" name="recommended" value="11" {{$supervisor->sup_status == '11' ? 'checked': ''}}> Not Recommended
                                </div>
                                <div class="form-group">
                                    <label style="width: 100%;font-weight: 700; margin-bottom: 10px;"> Supervisor Remarks:</label>
                                    <textarea class="rema" style="width: 80%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; border: none; margin-bottom: 20px;" name="super_remark"  @if (trim($supervisor->sup_remarks) != '') disabled @endif required="required">{{$supervisor->sup_remarks}}</textarea>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="defaultUnchecked" {{ $supervisor->sup_status == '' ? 'required' : 'checked disabled' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="cust-print">
                                    ...
                                    <a href="{{route('phdStudents.admin.index')}}" class="btn btn-success waves-effect waves-themed float-right">Back</a>
                                </div>
                              </div>
             </div>
                    </form>
