                ...
                <div class="card">
                    <div class="card-body">
                        <form id="provisionalForm" method="POST"
                            action="{{ route('provisional_reg_store') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="mb-2 row"><label class="form-label col-form-label col-md-4">6. NCR to
                                            ...
                                            <div class="col-md-8">
                                                <div>
                                                    <input type="text" class="form-control"
                                                        value="{{ $info->college_name }}" name="" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row"><label class="form-label col-form-label col-md-4">15.
                                            ...
                                            <div class="col-md-8">
                                                <div>
                                                    <input type="text" class="form-control"
                                                        value="{{ $formatted_date }}" name="thesis_submission_date"
                                                        readonly>
                                            ...
                                            <div class="col-md-8">
                                                <div>
                                                    <input class="form-check-input" type="radio"
                                                        name="course_completed" id="course_completed" value="1"
                                                        required> <b>Yes</b>&nbsp;&nbsp;
                                                    <input class="form-check-input" type="radio"
                                                        name="course_completed" id="course_completed" value="0"
                                                        required > <b>No</b>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <table>
                                ...
                                @foreach ($coursework_sub as $key => $val)
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" value="" name="grades[]" id="grades"
                                                required></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><input type="text" class="form-control"
                                            value="{{ $totalCredits }}" name="credit_completed" id="credit_completed" required></td>
                                </tr>
                            </table>
                            <h5>GRADE SHEET</h5>
                            <div class="col-md-4">
                                <span>Upload Grade Sheet:</span><span><input type="file" class="form-control"
                                        value="" name="grade_sheet" id="grade_sheet" required></span>
                            </div>
                            <br>
                            <hr>
                            <div class="row mb-4">
