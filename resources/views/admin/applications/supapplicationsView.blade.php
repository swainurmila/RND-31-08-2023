...
@section('sub-heading', 'Supervisor App View')
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="panel-container show" role="content">
                        ...
                        <div class="panel-content">
                            ...
                            <form action="#" method="post" class="comm_frm prev_wrap">
                                @csrf

                                {{-- <input type="submit"> --}}
                                {{-- <input type="hidden" value="{{$id}}" name="user_id"> --}}
                                <div class="input_wrap preview_form">
                                    <h3><b>Preview Co-Supervisor Information</b> </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label>Nature of Present Appointment as Teaacher/Scientist (Full time Regular /
                                                Contractual / Part-time / Guest / Resource Person):</label>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label
                                                class="form-label">{{ Helper::date_format($supervisors->dob, '-') }}</label>
                                        </div>
                                        <div class="col-md-3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="sup_quali_status[]"
                                                                    class="form-control processed status-width" required
                                                                    style="width:120px">
                                                            ...
                                                            <td>
                                                                <textarea name="sup_quali_remarks[]" class="form-control" required style="width:120px">{{ $value->control_cell_remarks }}</textarea>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                ...
                                                <tbody>
                                                    @foreach ($SupervisorEmployment as $key => $value)
                                                        <tr>
                                                            ...
                                                            <td>{{ Helper::date_format($value->from, '-') }}
                                                            </td>
                                                            <td>{{ Helper::date_format($value->to, '-') }}
                                                            </td>
                                                            <td>{{ $value->type }}</td>
                                                            <td>{{ Helper::date_format($value->appointment_date, '-') }}
                                                            </td>
                                                            <td><a href="javascript:void(0)"
                                                                    onclick="upload_image_view('/upload/phdsupervisor/{{ $value->employment_cerificate }}')">
                                                                    View File</a></td>
                                                            <td>
                                                                <select name="sup_emp_status[]"
                                                                    class="form-control processed status-width" required
                                                                    style="width:120px">
                                                                    <option value="">select</option>
                                                                    <option
                                                            ...
                                                            <td>
                                                                <textarea name="sup_emp_remarks[]" class="form-control" required style="width:120px">{{ $value->control_cell_remarks }}</textarea >
                                                            </td>
                                                        </tr>
@endforeach         
                                                </tbody>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Total Full-Time Experience in regular position in AICTE/UGC/Govt. recognised institution only (in years): {{ $supervisors->recognised_institution }}</label>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label d-none">{{ $supervisors->recognised_institution }}</label>
                                        </div>
                                    </div>
                                ...
                                <div class="input_wrap preview_form">
                                    <h3>
                                        <b>Publication in Journals during last five years (SCI/SCOPUS indexed / UGC listed journals):</b>
                                    </h3>
                                    <div class="row">
                                        <div class="col-md-3">
...
<tr>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <textarea name="sup_pub_remarks[]" class="form-control" required style="width:120px">{{ $value->control_cell_remarks }}</textarea >
                                              </td>
                                        </tr>
@endforeach
                                    </tbody>
...
<tr>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <textarea name="sup_jour_remarks[]" class="form-control" required style="width:120px">{{ $value->control_cell_remarks }}</textarea >
                                              </td>
                                        </tr>
@endforeach
                                    </tbody>
...
<tr>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <textarea name="sup_det_remarks[]" class="form-control" required style="width:120px">{{ $value->control_cell_remarks }}</textarea >
                                              </td>
                                        </tr>
@endforeach                                       
                                    </tbody>
                        ...
                        <div class="input_wrap preview_form">   
                            ...
                            <div class="col-md-8">
                                Remark:<textarea name="sup_certi_remarks" class="form-control" required >{{ $supervisors->control_cell_remarks }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        {{-- <div class="form-group">
                                <label style="width: 100%;font-weight: 700; margin-bottom: 10px;"> Supervisor
                                    Remarks:</label>
                                <textarea class="rema"
                                    ...
                                    name="super_remark" disabled required="required">dsfs</textarea>
                            </div>
                            <div class="form-group">
                                <label
                                    style="width: 100%;font-weight: 700; margin-bottom: 10px;">Remarks:</label>
                                <textarea class="rema"
                                    style="width: 80%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; border: none; margin-bottom: 20px;"
                                    name="chair_remark" required="required">sad</textarea>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultUnchecked"
                                    required>
                                <label class="custom-control-label" for="defaultUnchecked">I Agree and review
                                    the declaration / terms&amp;conditions</label>
                            </div> --}}
                                    </div>
