                    ...
                    @if (session('userdata')['role'] == 'student')
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                ...
                                <a href="{{ route('recommendation_dsc') }}" class="dropdown-item">Recommendation of
                                    DSC</a>
                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                <div class="dropdown">
                                    ...
                                    @php
                                        $reg = DB::table('semester_payments as p')
                                            ->select('p.draft_status as dstatus', 'p.id as pid')
                                ...
                                @php
                                    ...
                                    $diffInDays = $ldate ? $current_date->diffInDays($ldate) : null;
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-email">
                                ...
                                <div class="dropdown">
                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                        id="topnav-ecommerce" role="button" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="ri-shopping-cart-2-line align-middle me-1"></i> Change of research
                                        supervisor/co-supervisor<div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                        <a href="{{ route('changeof-research-supervisor') }}"
                                            class="dropdown-item">Apply for change supervisor/co-supervisor</a>
                                        <a href="{{ route('co-supervisor-change-list') }}" class="dropdown-item">View
                                            status</a>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-email">
                                ...
                                <a href="{{ route('discontinue-request') }}" class="dropdown-item">Discontinuation as
                                    Ph.D</a>
                                <a href="{{ url('supervisor/recommendation-dsc') }}"
                                    class="dropdown-item">Recommendation of DSC</a>
                            </div>
                            {{-- <div class="dropdown-menu" aria-labelledby="topnav-email">
