                            ...
                            <div class="custom-accordion">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form action="{{ route('cosup.coursework-application-update') }}" method="post"
                                        ...
                                        <br>
                                        <div class="row">
                                            @if ($coursework_appl_remarks->dsc6_status == 0)
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="comment" id="comment" class="form-control" cols="30" rows="2"
                                                        placeholder="{{ $coursework_appl_remarks->dsc6_remarks }}Enter Coursework remarks here..." value="" required></textarea>
                                                </div>
                                            @else
                                                <div class="col-md-12">
                                                    <span style="font-weight: bold">Co-Supervisor Comment:
                                                    </span><span><b>{{ $coursework_appl_remarks->dsc6_remarks }}</b></span>
                                                </div>
                                            @endif
                                        </div><br>
                                        <div class="text-center">
                                            ...
                                            @if ($coursework_appl_remarks->dsc6_status === 0 || empty($coursework_appl_remarks->dsc6_remarks))
                                                <input type="submit"
