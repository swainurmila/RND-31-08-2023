                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('cosupervisors.store.draft',[$id]) }}" class="form" method="POST"
                                        ...
                                        <div class="tab">
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="custom-select form-control" id="faculty"
                                                        ...
                                                        <option value="Architecture" {{ $supervisor->faculty == 'Architecture' ? 'selected' : '' }}>Architecture</option>
                                                        <option value="Engineering" {{ $supervisor->faculty == 'Engineering' ? 'selected' : '' }}>Engineering</option>
                                                        <option value="Management" {{ $supervisor->faculty == 'Management' ? 'selected' : '' }}>Management</option>
                                                        <option value="Pharmacy" {{ $supervisor->faculty == 'Pharmacy' ? 'selected' : '' }}>Pharmacy</option>
                                                        <option value="Computer Application & Science" {{ $supervisor->faculty == 'Computer Application & Science' ? 'selected' : '' }}>Computer
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="full_name" name="full_name" value="{{$supervisor->name}}"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="organisation" name="organisation" value="{{$supervisor->institution_organisation}}"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="nature_of_appointment"
                                                        ...
                                                        placeholder="Enter name of the institution" value="{{$supervisor->present_appointment}}">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="date" id="date_of_birth" name="date_of_birth"
                                                                class="form-control" placeholder="Enter DOB." value="{{$supervisor->dob}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" id="age" name="age"
                                                                class="form-control" placeholder="Enter Age" value="{{$supervisor->age}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                                ...
                                                                <option value="single" {{ $supervisor->marital_status == 'single' ? 'selected' : '' }}>Single</option>
                                                                <option value="married" {{ $supervisor->marital_status == 'married' ? 'selected' : '' }}>Married</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        <label class="col-md-4 col-form-label"
                                                            for="permanent_address"><b>Permanent address: <span
                                                                    class="error">*</span></b></label>
                                                        <div class="col-md-7">
                                                            <textarea class="form-control" id="permanent_address" rows="5" name="permanent_address">{{$supervisor->permanent_address}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea class="form-control" id="correspondance_address" rows="5" name="correspondance_address">{{$supervisor->correspondence_address}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" id="natinality" name="natinality"
                                                                class="form-control" placeholder="Enter your Nationality" value="{{$supervisor->nationality}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="discipline_specialization"
                                                                ...
                                                                placeholder="Enter your descipline/specialization" value="{{$supervisor->disciline_specialization}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="number" id="aadhar_card_number"
                                                                ...
                                                                placeholder="Enter your aadhar card number" value="{{$supervisor->aadhar_no}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="file" id="aadhar_card_certi"
                                                                ...
                                                                <input type="hidden" name="aadhar_card_hid" value="{{ $supervisor->aadhar_file }}">
                                                                <a href="javascript:void(0)"
                                                                            onclick="upload_image_view('/upload/supervisor/aadhar/{{ $supervisor->aadhar_file }}')">
                                                                            View Upload File</a>
                                                        </div>
                                                    </div>
                                                </div>
