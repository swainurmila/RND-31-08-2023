            ...
            <div class="card">
                <div class="card-body">
                    <div class="section-title form-section-title mb-3">
                        <h3 class="text-center"><b>Recommendation of Co-Supervisor For Provisional Registration to Ph.D
                                Programme of BPUT</b>
                        </h3>
                    </div>
                    <div class="row">
                        ...
                        <form method="post" action="{{ route('cosup.provisional-registration-submit', [$id]) }}"
                            ...
                            <div class="row">
                                @if ($provisional->status == 2)
                                    <div class="col-md-2">
                                        <span>Recommendation of Co-Supervisor:</span>
                                    </div>
                                    <div class="col-md-3">
                                        <select name="status" class="form-control" required>
                                            <option value="">--------select--------</option>
                                            <option value="4">Satisfactory</option>
                                            <option value="5">Not Satisfactory</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1">
                                        <span>Comment:</span>
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="cosup_remark" id="cosup_remark" class="form-control" cols="30" rows="2"
                                            placeholder="{{ $provisional->cosup_remark }}Enter Provisional registration remarks here..." required></textarea>
                                    </div>
                                @else
                                    <div class=" mb-4 card">
                                        <div class="row">
