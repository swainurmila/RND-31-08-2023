...
@section('heading', 'Co-Supervisor Form Preview')
@section('sub-heading', 'Co-Supervisor Form Preview')
@section('content')
            ...
            <div class="row">
                ...
                <div class="panel-content">                                 
                    ...
                    <form action="{{ route('cosup.preview.submit') }}" method="post" class="comm_frm prev_wrap">
                        @csrf
                        ...
                        <h3><b>Preview Supervisor Information</b> </h3>
                                                  ...
                                                  <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label class="form-label" style="text-transform: capitalize">{{$supervisors->name}}</label>
                                                        </div>
                                                        <div class="col-md-3">
                                                             <label>Faculty:</label>
                                                        </div>
                               ...
                               <div class="col-md-3">
                                   <label class="form-label">
                                    {{-- <a href="javascript:void(0)"
                                        ...
                                        View File</a> --}}
                                        <img style="max-width: 80px;" src="/upload/employee_photo/{{ $supervisors->photo }}" alt="">
                                </label>
                               </div>
                            </div>
                        ...
                        <div class="input_wrap preview_form">                               
                            ...
                            <div class="row"> 
                                <div class="cust-print">    
                                    <a href="#" class="btn btn-success waves-effect waves-themed float-right">Back</a>
