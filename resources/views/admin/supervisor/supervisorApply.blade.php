                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('supervisors.store') }}" class="form" method="POST"
                                        ...
                                        <div class="tab">
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" d="full_name" name="faculty" value=""
                                            ...
                                            <div class="mb-2 row">
                                                <label class="col-md-4 col-form-label" for="nature_of_appointment"><b>Nature
                                                        ...
                                                        as Teacher/Scientist:
                                                        {{-- (Full time Regular / Contractual /
                                                        Part-time / Guest / Resource Person):  --}}
                                                        <span class="error">*</span></b></label>
                                                <div class="col-md-8">
                                                    <select class="custom-select form-control" id="nature_of_appointment"
                                                        name="nature_of_appointment">
                                                        <option value="">------Select------</option>
                                                        <option value="single">Full time Regular</option>
                                                        <option value="married">Contractual</option>
                                                        <option value="married">Part-time</option>
                                                        <option value="married">Guest</option>
                                                        <option value="married">Resource Person</option>
                                                    </select>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        <label class="col-md-4 col-form-label"
                                                            for="discipline_specialization"><b>Discipline &
    ...
    <script>
        $(document).ready(function() {
            $('#aadhar_card_number').on('input', function() {
                var adhaarNumber = $(this).val();

                if (adhaarNumber.length > 12) {
                    $(this).val(adhaarNumber.slice(0, 12)); // Truncate the input to 10 digits
                }
            });
        });
    </script>
