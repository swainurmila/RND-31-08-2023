...
@section('heading', 'Supervisor Application Info')
@section('sub-heading', 'Supervisor Application Info')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                @if ($draft_status == 1)
                                    <div class="panel-content">
                                        ...
                                        <a href="{{ route('sup.education.view', [$user_id]) }}">click here to complete your
                                            form</a>
                                    </div>
                                @endif
                                @if ($draft_status == 2)
                                    <div class="panel-content">
                                        <h1>Form Incomplete</h1>
                                        <a href="{{ route('sup.journal.view', [$user_id]) }}">click here to complete your
                                            form</a>
                                    </div>
                                @endif
                                @if ($draft_status == 3)
                                    <div class="panel-content">
                                        <h1>Form Incomplete</h1>
                                        <a href="{{ route('journal.draft.view', [$user_id]) }}">click here to complete your
                                            form</a>
                                    </div>
                                @endif
                                ...
                                @if ($draft_status == 4)
                                    <div class="panel-content">
                                        ...
                                        <p>status: your status {{ $status }} <a href="{{route('apply-form-view', $supervisorDetails->sup_id
