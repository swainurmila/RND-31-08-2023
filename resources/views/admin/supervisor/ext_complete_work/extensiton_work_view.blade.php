                    ...
                    <div class="card-body">
                        <div class="panel-container show" role="content">
                            <div class="panel-content" style="padding: 20px 30px; ">
                                ...
                                <table class="table">
                                    ...
                                    <form method="post" action="{{ route('extention.work.status',[$student->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="app_div">
                                            <div class="row">
                                                <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label>Status</label>
                                <input class="form-control" type="text" value="{{ $student->application_status == 2 ? 'Recommended' : 'Not Recommended' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label>Remarks</label>
