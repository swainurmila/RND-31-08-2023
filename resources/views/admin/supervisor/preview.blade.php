                    ...
                    <div class="panel-content">
                        ...
                        <?php if($type == 'Supervisor'){ ?>
                            <table class="mb-2">
                                ...
                                <tr>
                                    <td><b>Present Research Co.Supervisor Name:</b></td>
                                    <td>{{ $student->pres_cosupervisor_name }}</td>
                                    <td><b>Proposed Research Co.Supervisor Name:</b></td>
                                    <td>{{ $student->pros_resc_cosupervisor }}</td>
                                </tr>
                                <tr>
                                    <td><b>Approved By BPUT:</b></td>
                                    <td>{{ $student->approved_by_bput	 }}</td>
                                    <td><b>Proposed Nodal Research Centre:</b></td>
                                    <td>{{ $student->proposed_nodal_centre }}</td>
                                </tr>
                                <tr>
                                    <td><b>Reason For Change:</b></td>
                                    <td>{{ $student->reason_for_change}}</td>
                                    <td><b>Name Of Proposed Co.Supervisor:</b></td>
                                    <td>{{ $student->proposed_co_supervisor }}</td>
                                </tr>
                            </table>
                        ...
                        <?php } ?>
                        <form action="{{ route('supervisor.approve-preview-application',['id' => $id]) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option value="1" {{ $student->application_status == 4 ? 'selected' : '' }}>
                                            Approve</option>
                                        <option value="2" {{ $student->application_status == 5 ? 'selected' : '' }}>
                                            Reject</option>
                                    </select>
                                </div>
                                <div class="col-4">
                                    <label for="">Remarks</label>
                                    <textarea name="application_remark" class="form-control" required>{{ $student->control_cell_remarks != '' ? $student->control_cell_remarks : '' }}</textarea>
                                </div>
                            </div>
