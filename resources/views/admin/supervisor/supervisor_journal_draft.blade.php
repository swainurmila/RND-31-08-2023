                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('journal.draft.store', [$id]) }}" class="form" method="POST"
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="total_journals_paper" name="total_journals_paper"
                                                    class="form-control" placeholder="Enter total journals paper" value="{{$supervisors->no_papers_journals}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" id="phd_total_number" name="phd_total_number"
                                                        class="form-control" placeholder="Enter total number" value="{{$DetailsOfSupervisor->tot_no_supervising}}">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="number" id="as_supervisor" name="as_supervisor"
                                                                class="form-control" placeholder="Enter number as supervisor" value="{{$DetailsOfSupervisor->no_as_supervisor}}">
                                                            nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" id="as_cosupervisor" name="as_cosupervisor"
                                                                class="form-control" placeholder="Enter number as co-supervisor" value="{{$DetailsOfSupervisor->no_as_cosupervisor}}">
                                                            nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="number" id="as_unreserved" name="as_unreserved"
                                                                class="form-control" placeholder="Enter number as Unreserved" value="{{$DetailsOfSupervisor->unreserved}}">
                                                            nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" id="as_st_sc" name="as_st_sc"
                                                                class="form-control" placeholder="Enter number as ST/SC" value="{{$DetailsOfSupervisor->sc_st}}"> nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="number" id="as_differently_abled"
                                                                ...
                                                                placeholder="Enter number as Differently Abled" value="{{$DetailsOfSupervisor->differently_abled}}">
                                                            nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" id="as_national_test_qualified"
                                                                ...
                                                                placeholder="Enter number as national test " value="{{$DetailsOfSupervisor->test_qualified}}">
                                                            nos.
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" id="as_anyother" name="as_anyother"
                                                                class="form-control" placeholder="Enter number if any other" value="{{$DetailsOfSupervisor->other}}"> nos.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="email" id="email" name="mailid_head_institute"
                                                        class="form-control" placeholder="Enter mail id of the institute" value="{{$DetailsOfSupervisor->mail_id_head}}">
                                            ...
                                            <div>
                                                <div class="mt-5 text-center">
                                                    ...
                                                    <a href="{{ route('draft.education.view', [$id]) }}" class="submit" type="submit">previous</a>
                                                </div>
                                            </div>
                                        </div>
