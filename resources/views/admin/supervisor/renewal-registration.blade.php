                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="custom-accordion">
                                        ...
                                        <hr>
                                        @if($value->status == 0)
                                        <form action="{{url('supervisor/renewal-registration-store', $value->id)}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <select name="status" id="" class="form-control">
                                                        ...
                                                        <option value="0">Not Recommended
                                                    </option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <label for="">Remarks</label>
                                                    <textarea name="remark_supervisor" class="form-control" required></textarea>
                                                </div>
                                            </div>
