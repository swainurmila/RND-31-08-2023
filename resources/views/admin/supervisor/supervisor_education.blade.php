                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('sup.store.edu', [$id]) }}" class="form" method="POST"
                                                ...
                                                <table class="table table-sm m-0 table-bordered">
                                                    ...
                                                    <tbody class="addnewrow">
                                                        <tr>
                                                            <td>
                                                                10th
                                                                <input type="hidden" name="exam[]" value="HSC">
                                                            </td>
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" id="hsc_spec" name="spec[]"
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <select class="custom-select form-control chk_blank"
                                                                        id="hsc_year" name="year[]" id="passing_year">
                                                                        <option value="">Select Years</option>
                                                                        @for ($i = date('Y'); $i >= date('Y') - 50; $i--)
                                                                            <option value="{{ $i }}">
                                                                                {{ $i }}</option>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="file"
                                                                        class="form-control quali_certi chk_blank_file"
                                                                        name="certi[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="plus_two_percent" name="percent[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Graduation
                                                                <input type="hidden" name="exam[]" value="Graduation">
                                                            </td>
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" id="plus_three_spec"
                                                                        name="spec[]" class="form-control chk_blank">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="plus_three_board" name="board[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="plus_three_class" name="class[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="plus_three_percent" name="percent[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" id="post_gradu_spec"
                                                                        name="spec[]" class="form-control chk_blank">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="post_gradu_board" name="board[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="post_gradu_class" name="class[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" class="form-control chk_blank"
                                                                        id="post_gradu_percent" name="percent[]">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                MPhil
                                                                <input type="hidden" name="mphil_exam" value="MPhil">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="mphil_spec" name="mphil_spec"
                                                                    class="form-control">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    id="mphil_board" name="mphil_board">
                                                            </td>
                                                            <td>
                                                                <select class="custom-select form-control" id="mphil_year"
                                                                    name="mphil_year" id="passing_year">
                                                                    <option value="">Select Years</option>
                                                                    @for ($i = date('Y'); $i >= date('Y') - 50; $i--)
                                                                        <option value="{{ $i }}">
                                                                            {{ $i }}</option>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    id="mphil_class" name="mphil_class">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    id="mphil_percent" name="mphil_percent">
                                                            </td>
                                                            <td>
                                                                <input type="file" class="form-control quali_certi"
                                                                    name="mphil_certi">

                                                            </td>
                                                            <td>
                                                                <input type="file" class="form-control quali_mark"
                                                                    name="mphil_mark">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Ph.D
                                                                <input type="hidden" name="exam[]" value="Ph.D">
                                                            </td>
                                                            <td>
                                                                <div class="input-cont">
                                                                    <input type="text" id="phd_spec" name="spec[]"
                                                                        class="form-control chk_blank">
                                                                    <span class="error-msg"></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="input-cont">
                                                                    <select class="custom-select form-control chk_blank"
                                                                        id="phd_year" name="year[]" id="passing_year">
                                                                        <option value="">Select Years</option>
                                                                        @for ($i = date('Y'); $i >= date('Y') - 50; $i--)
                                                                            <option value="{{ $i }}">
                                                                                {{ $i }}</option>
                                        ...
                                        <div class="tab">:
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="phd_thesis" name="phd_thesis"
                                                        class="form-control" placeholder="Enter Thesis">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" id="full_time_total_exp"
                                                        ...
                                                        placeholder="Enter Full Time experience in years">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row" id="add_employment3">
                                                ...
                                                <div class="col-md-4 cust-txt-input2">
                                                    ...
                                                    <input type="number" id="research_exp" name="research_exp"
                                                        class="form-control"
                                                        placeholder="Enter Research experience in years">
                                                </div>
                                                <div class="col-md-4 cust-txt-input2">
                                                    ...
                                                    <input type="number" id="phd_exp" name="phd_exp"
                                                        class="form-control" placeholder="Enter Ph.D experience in years">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="mt-5 text-center">
                                                    ...
                                                    <a href="{{ route('store.draft.view', [$id]) }}" class="submit" type="submit">previous</a>
                                                </div>
                                            </div>
