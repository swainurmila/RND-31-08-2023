                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="panel-content">
                                    ...
                                    <form action="{{ route('supervisors.store.draft', [$id]) }}" class="form"
                                        ...
                                        <div class="tab">
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" d="full_name" name="faculty"
                                                        value="{{ $supervisor->faculty }}" class="form-control"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="full_name" name="full_name"
                                                        value="{{ $supervisor->name }}" class="form-control"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="organisation" name="organisation"
                                                        value="{{ $supervisor->institution_organisation }}"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="nature_of_appointment"
                                                        ...
                                                        value="{{ $supervisor->present_appointment }}">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <select class="custom-select form-control" id="marital_status"
                                                                ...
                                                                <option value="single"
                                                                    {{ $supervisor->marital_status == 'single' ? 'selected' : '' }}>
                                                                    Single</option>
                                                                <option value="married"
                                                                    {{ $supervisor->marital_status == 'married' ? 'selected' : '' }}>
                                                                    Married</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="custom-select form-control" id="gender"
                                                                ...
                                                                <option value="Male"
                                                                    {{ $supervisor->gender == 'Male' ? 'selected' : '' }}>
                                                                    Male</option>
                                                                <option value="Female"
                                                                    {{ $supervisor->gender == 'Female' ? 'selected' : '' }}>
                                                                    Female</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-select " id="discipline_specialization"
                                                                name="discipline_specialization">
                                                                @foreach ($dept as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ $supervisor->discipline_specialization == $item->id ? 'selected' : '' }}>
                                                                        {{ $item->departments_title }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <input type="hidden" name="aadhar_card_hid"
                                                                value="{{ $supervisor->aadhar_file }}">
