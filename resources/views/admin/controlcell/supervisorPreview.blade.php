         ...
         @include('admin.partials.breadcrumb')
            <div class="row">
                ...
                <div class="panel-content">                                 
                    ...
                    <form action="{{ route('rndcell.prev_super_subm',[$id]) }}" method="post" class="comm_frm prev_wrap">
                        @csrf
                        ...
                        <div class="input_wrap preview_form">   
                            ...
                            <div class="row">
                                ...
                                <div class="cust-print">
                                    ...
                                    <a href="{{route('rndcell.draft_supervisor.data',[$id])}}" class="btn btn-success waves-effect waves-themed">back</a>
