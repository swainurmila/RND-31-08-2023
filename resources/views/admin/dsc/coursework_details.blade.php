                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-accordion">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form action="{{ route('dsc.update-coursework-remarks') }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <span>Recommendation of Expert :</span>
                                            </div>
                                            <div class="col-md-3">
                                                <select name="recommendation_status" id="recommendation_status" class="form-control" required>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <textarea name="remarks" id="remarks" class="form-control" cols="30" rows="2"
                                                    placeholder="Enter Coursework remarks here..." required></textarea>
                                            </div>
                                        </div><br>
                                        <div class="text-center">
                                            <input type="submit"
                                            ...
                                            <tr class="trbg">
                                                <th>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3"><h5>Expert Remark over Course Work :</h5></div>
