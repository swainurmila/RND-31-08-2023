                                    ...
                                    <div class="custom-accordion">
                                        ...
                                        <table class="mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="fix">Name Of NCR</span><span class="value">:     {{$value->ncr_name}}</span></td>
                                                
                                            </tr>
                                            <tr>
                                                <td> <span class="fix">Faculty of</span><span class="value">:     {{$value->faculty}}</span> </td>
                                                <td><span class="fix">Discipline / Specialisation</span><span class="value">:     {{$value->discipline}}</span></td>
                                            ...
                                            <tr>
                                                <td colspan='2'><span class="fix">Progress in research work till date</span><span class="value">:     {{$value->progress}}</span></td>
                                            </tr>
                                            <tr>
                                                <td colspan='2'><span class="fix">Schedule period of completion of the work</span><span class="value">:     {{$value->schedule_period}}</span></td>
                                            </tr>
                                            <tr>
                                                <td colspan='2'><span class="fix">Reason of non-completion in due time</span><span class="value">:     {{$value->reason_of_non_completion}}</span></td>
                                            </tr>
                                            <tr>
                                                <td colspan='2'><span class="fix">Expected time of completion of work</span><span class="value">:     {{$value->expected_completion}}</span></td>
                                            </tr>
                                            <tr>
                                                <td colspan='2'><span class="fix">Expected time-frame for submission of thesis and period of extension sought</span><span class="value">:     {{$value->expected_submission}}</span></td>
                                            </tr>
                                        </table>
                                        <hr>
                                        ...
                                        <form action="{{url('control-cell/renewal-registration-store', $value->id)}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-6">
                                                    <input type="hidden" name="type" value="" />
                                                    ...
                                                    <select name="status" id="" class="form-control">
                                                        ...
                                                        <option value="5">Not Recommended
                                                    </option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <label for="">Remarks</label>
                                                    <textarea name="remark_controlcell" class="form-control" required></textarea>
                                                </div>
                                            </div>
