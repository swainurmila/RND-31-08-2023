...
@section('content')
                ...
                <div class="panel-content">
                    ...
                    <form action="{{ route('control-cell.sup.control.remark.store',[$id]) }}" method="post" class="comm_frm prev_wrap">
                        @csrf
                        ...
                        <div class="input_wrap preview_form">
                            ...
                            <div class="border border-primary" style="margin-top:10px;"></div>
