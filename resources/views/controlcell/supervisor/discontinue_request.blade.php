            ...
            <div class="card-body">
                <table class="table table-hover m-0 table-centered  nowrap w-100" cellspacing="0" id="dataTable">
                    ...
                    <tbody class="font-14">
                        ...
                        @if($value->status == 4 || $value->status == 6 || $value->status == 8)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td>{{ $value->name }}</td>
                            ...
                            <td><a href="{{url('control-cell/discontinue-registration', $value->id)}}" class="action-icon"> <i class="mdi mdi-eye"></i></a></td>
                        </tr>
                        @endif
                        @endforeach
                    </tbody>
