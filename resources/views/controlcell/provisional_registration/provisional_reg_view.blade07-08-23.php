    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form method="post" action="{{ route('control-cell.provisional-registration-submit', [$id]) }}"
                            ...
                            class="{{ in_array($provisional->status, [8, 10, 11]) ? 'd-block' : 'd-none' }}">
                            @csrf
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                @if ($provisional->status == 8)
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="rnd_remark" id="rnd_remark" class="form-control" cols="30" rows="2"
                                            placeholder="{{ $provisional->rnd_remark }}Enter Provisional registration remarks here..." required></textarea>
                                    </div>
                                @else
                                    <div class="mb-4 card">
                                        <div class="row">
                ...
                <div class="row mt-4 mb-2 {{ in_array($provisional->status, [8, 9, 10, 11]) ? 'd-block' : 'd-none' }}">
