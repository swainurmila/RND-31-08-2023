                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="custom-accordion">
                                        ...
                                        <hr>
                                        @if($value->rd_approved == 0)
                                        <form action="{{url('control-cell/change-nodal-remark', $value->id)}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-6">
                                                    <input type="hidden" name="type" value="" />
                                                    <label for="">Application Status</label>
                                                    <select name="rd_approved" id="" class="form-control">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <textarea name="controlcell_remark" class="form-control" required></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <form action="#" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="">Remarks</label>
                                                    <textarea name="remark_controlcell" class="form-control" readonly>{{ $value->controlcell_remark}}</textarea>
                                                </div>
                                            </div>
                                        </form>
                                        @endif
