                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-container show" role="content">
                                ...
                                <div class="section-title form-section-title mb-3">
                                                            ...
                                                            <div class="col-md-12">
                                                              ...
                                                              <div class="col-md-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <a href="javascript:void(0);"
                                                                            onclick="upload_image_view('{{ route('control-cell.semester-payment.payment', $payment_details->id) }}')"
                                    ...
                                    <form method="post" action="{{ route('control-cell.semester-register-store', [$id]) }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                            <div class="row">
                                                @if ($payemt_status->status == 6)
                                                    <div class="col-md-2">
                                                        <span>Approval of R&D cell:</span>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-5">
                                                        <textarea name="rnd_remark" id="rnd_remark" class="form-control" cols="30" rows="2"
                                                            placeholder="{{ $payemt_status->rnd_remark }}Enter Semester remarks here..." required></textarea>
                                                    </div>
                                                @else
                                                    <table class="table table-bordered coursework-form-display-table">
                                                        <tr class="trbg">
                                                            <th>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <h5>R&D cell Remark on Semester Registration:</h5>
                                                                    </div>
                                                                    <div class="col-md-9">
                                                                        <h5> {{ $payemt_status->rnd_remark }}</h5>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        </tr>
