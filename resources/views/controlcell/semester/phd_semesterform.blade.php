                    ...
                    <section class="fee_structure ">
                        <div class="section-title form-section-title dsc-form">
                            <center>
                                ...
                                <h5><u><b>SEMESTER REGISTRATION FORM FOR Ph.D. PROGRAMME
                                        </b></u>
                                </h5>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $reg_details->enrollment_no }} ||
                                                    {{ $reg_details->enrollment_date }}</td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="row">
                            ...
                            <h5>Signature of members of DSC
                                ...
                                <div class="row ">
                                    <div class="col-md-12">
                                        <div class="payment">
                                            <h5>1. All the Semester dues till date has been cliered upto date & copies are enclosed: YES/NO</h5>
                                            <h5>2. Rs 3000/- (Fee submitted to BPUT)Receipt No / Draft No: <b style="color: red">{{$reg_details->transaction_id}}</b> , issuing
                                                Office/ Bank <b style="color: red">{{$reg_details->bank_name}}</b>,   Date: <b style="color: red">{{$reg_details->transaction_date}}</b> (To be enclosed) </h5>
                                            <h5>3. Rs 7000/- (Fee submitted to: NCR) Receipt No / Draft No: <b style="color: red">{{$reg_details->draft_no}}</b>  , Issuing
                                                Office/ Bank <b style="color: red">{{$reg_details->transaction_date}}</b> , Date: <b style="color: red">{{$reg_details->date}}</b> </h5>
                                        </div>
                            ...
                            <h5>Signature of tbc Heed of NCR</h5>
                                ...
                                <div class="row office">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <h6>Amount of Fee paid Rs. <b style="color: red">3000</b> & the University
                                            Receipt No. / Bank DD No. <b
                                                style="color: red">{{ $reg_details->transaction_id }}</b> & Date <b
                                                style="color: red">{{ $reg_details->transaction_date }}</b> (Attach
                                            photo copy of the University Receipt/Bank DD).</h6>
                                    </div>
                                </div>
                            ...
                            <h6>PIC(R&D)BPUT</h6>
                                ...
                                <div class="app_div" style="width: 90%;margin:30px auto;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label>Status of NCR</label>
                                            <select class="form-control" name="nod_sem_approve" id=""
                                                required readonly>
                                                <option>-- select --</option>
                                                <option value="1" {{ $reg_details->nodal_status == 1 ? "selected" :""}}>Approved</option>
                                                <option value="0" {{ $reg_details->nodal_status == 0 ? "selected" :""}}>Not Approved</option>
                                            </select>
                                        </div>
                                        ...
                                        {{-- <form method="POST" action="{{ route('nodalcentre.semester.status',[]) }}"> --}}
                                            <div class="col-md-6">
                                                <label>Remarks of NCR</label>
                                                <textarea class="form-control" name="con_remarks" id="" cols="5" rows="2" required readonly>
                                                    {{ $reg_details->nodal_remark }}
                                                </textarea>
                                            </div>

                                    </div>
                                </div>
                                @if ($reg_details->control_status == '')
                                    <form method="POST"
                                        action="{{ route('control-cell.semester.status', [$reg_details->semister_reg_id]) }}">
                                        @csrf
                                        <div class="app_div" style="width: 90%;margin:30px auto;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label>Remarks</label>
                                                        <textarea class="form-control" name="con_remarks" id="" cols="5" rows="2" required ></textarea>
                                                    </div>
