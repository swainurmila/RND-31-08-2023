                    ...
                    <tbody class="font-14">
                        @foreach ($semester_details as $key => $value)
                            <tr>
                                ...
                                <td><span
                                    class="badge @if ($value->control_status == '')bg-warning @elseif($value->control_status == 1)bg-success @else bg-danger @endif"> @if ($value->control_status == '')
                                        pending
                                    @elseif($value->control_status == 1)
                                        Verified
                                    @else
                                        Rejected
                                    @endif  </span></td>
                                ...
                                <td class="table-action">
                                    <a href="{{route('control-cell.semester.view',[$value->semister_reg_id])}}"
