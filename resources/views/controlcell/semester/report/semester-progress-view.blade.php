                    ...
                    <div class="card-body">
                        <div class="panel-container show" role="content">
                            <div class="panel-content" style="padding: 20px 30px; ">
                                ...
                                <div class="col-md-12">
                                    <span style="color: red;">&#x2605;</span><span><b>SEMESTER PROGRESS REPORT SIGNED BY THE
                                            DSC AT THE NCR LETTER :
                                        </b></span><span>
                                ...
                                <table class="table table-bordered coursework-form-display-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="col-md-9">
                                                <h5> {{ $student_sem_detaills->control_remarks }}</h5>
                                            </div>
                                        </th>
                                    </tr>
                                </table>
                                <form action="{{ route('control-cell.control.semester.store', [$id]) }}" method="post"
                                    id="coursework_form" name="coursework_form" enctype="multipart/form-data">
                                    @csrf
                                    <br><br>
                                    @if ($student_sem_detaills->status == 6)
