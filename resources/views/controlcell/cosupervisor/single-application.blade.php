                ...
                <div class="card-body">
                    ...
                    <div class="panel-container show" role="content">
                        ...
                        <div class="panel-content">
                            ...
                            <form action="{{ route('control-cell.cosup.control.remark.store', [$id]) }}" method="post"
                        ...
                        <div class="input_wrap preview_form">   
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($supervisors->application_status == 1)
                                        <div class="row">

                                            <div class="cust-print mt-4 text-center">

                                                <button type="submit"
                                                    class="btn btn-success waves-effect waves-themed">Save As
                                                    Draft</button>
                                            </div>
                                        </div>
                                    @endif
